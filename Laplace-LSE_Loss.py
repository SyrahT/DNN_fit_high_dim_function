...
R_variable['astddev'] = 2/np.square(R_variable['input_dim']+R_variable['output_dim'])# For weight
R_variable['bstddev'] = 2/(R_variable['input_dim']+R_variable['output_dim'])# For bias
